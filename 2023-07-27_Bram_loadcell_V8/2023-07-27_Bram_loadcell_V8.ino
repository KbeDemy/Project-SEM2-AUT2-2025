const int gewicht = 2000; //force in grams
//-------------------------------------------------------------------------------------------------------------------
#include <HX711_ADC.h>
#include <EEPROM.h>

/*pins:
mcu > HX711 dout pin proberen op een andere pin aan te sluiten 
...
void setup() {
  ...
  calibrationValue = -231.3;  // uncomment this if you want to set the calibration value in the sketch
